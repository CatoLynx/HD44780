...
def main():
	...
	display = hd47780.Display(backend = hd47780.DummyBackend, pinmap = PINMAP, lines = 2, columns = 16, debug = False)
	display.clear()
	display.home()
	ui = hd47780.DisplayUI(display, hd47780.NoInput, debug = True)
	while True:
